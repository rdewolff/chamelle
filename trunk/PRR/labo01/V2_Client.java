...
public class V2_Client extends Config
{
	...
	public static void main (String args[]) throws IOException {
		try {
			...
			// message recu : "HELO"
			int TAILLE_TAMPON_SYNCHRO = query.length()*TAILLE_CHAR; 
			byte[] tampon;
			...
			while (true) {
				try {
					// definit la taille miniumm necessaire.
					tampon = new byte[TAILLE_TAMPON_SYNCHRO]; 
					 ...
					 */
					// reinit le tampon avec la bonne taille
