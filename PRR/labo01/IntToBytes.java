...
public class IntToBytes {
	 ...
	 * 
	 * param in l'entier a convertir; param out tableau d'octets, il doit y en
	 * avoir au moins 4 octets de libres param offset decalage depuis le debut
	 * du tableau out Valeur de retour: nombre d'octets inseres. Toujours 4.
	 */
	 ...
	 * un entier 32 bits.
	 * 
	 * param in suite d'octets formant un entier; param offset decalage depuis
	 * le debut du tableau in ou se trouve l'entier a convertir. Valeur de
	 * retour: entier converti.
	 */
